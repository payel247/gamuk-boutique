...
const FAQ = () => {
  const faqs = [
    {
      q: "What is a Gamuk?",
      a: "A Gamuk (also known as an African Net Sponge or sponge net) is a traditional exfoliating washcloth used widely in West Africa, particularly in Nigeria, Ghana, and neighboring countries. It is made of a durable, hand-knotted nylon net that provides superior exfoliation compared to standard loofahs."
    },
    {
      q: "How do I use it?",
